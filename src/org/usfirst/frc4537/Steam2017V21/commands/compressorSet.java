 ...
 *
 */
public class compressorSet extends Command {

	private int setting = 0; //0=Off, 1=On, 2=Toggle
	
    public compressorSet(int i) {
		setting = i;
	}
    ...
    protected void execute() {
    	...
    	if (setting == 0) {
    		...
    		System.out.println(Pneumatics.compressorGetMode());
