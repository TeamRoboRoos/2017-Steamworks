...
public class OI {
    ...
    public Joystick tankLeft;
    public Joystick tankRight;
    ...
    public OI() {
        ...
        arcade = new Joystick(3);
        
        tankRight = new Joystick(2);
        
        tankLeft = new Joystick(1);
        
        buttonBoard = new Joystick(0);
        
        climbButton = new JoystickButton(buttonBoard, 1);
        climbButton.whileHeld(new climb());
        
        stopClimbButton = new JoystickButton(buttonBoard, 2);
        stopClimbButton.whenPressed(new climbStop());
        ...
        SmartDashboard.putData("feeder", new feeder());
    ...
    public Joystick getTankLeft() {
        return tankLeft;
    }

    public Joystick getTankRight() {
        return tankRight;
    }
